...
public class MenuResp {
    ...
    public static List<MenuResp> toList(IDictItem[] value) {
        return Arrays.stream(value).map(t -> new MenuResp(t.getLabel(), t.getValue())).collect(Collectors.toList());
    }
    ...
    public static List<MenuResp> toList(List<? extends IDictItem> systems) {
        ...
        return systems.stream().map(t -> new MenuResp(t.getLabel(), t.getValue())).collect(Collectors.toList());
    }
}
